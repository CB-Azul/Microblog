...
def index():
    ...
    posts = db.paginate(current_user.following_post(), page=page,
    ...
    return render_template('main.index.html', title=_('Home Page'), form=form, posts=posts.items, next_url=next_url, prev_url=prev_url)
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(_('Profile changes have been saved!'))
